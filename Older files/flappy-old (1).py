...
class Flappy:
    ...
    def draw_ball(self):
        ...
        image_path = os.path.join(current_path, 'imgs') # The image folder path
        self.bg = pg.image.load(os.path.join(image_path, 'bg3.png'))
        self.bird = pg.image.load(os.path.join(image_path, 'bird1.png'))
        self.pos_x = 100
        self.ball_size = 20
        # pg.draw.circle(Flappy.dp, Flappy.white, (self.pos_x,
        #                                          Flappy.pos_y), self.ball_size, self.ball_size)
        Flappy.dp.blit(self.bg, (0, 0))
        Flappy.dp.blit(self.bird, (self.pos_x, Flappy.pos_y))
